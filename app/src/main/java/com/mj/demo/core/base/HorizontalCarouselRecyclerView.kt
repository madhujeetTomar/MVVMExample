...
class HorizontalCarouselRecyclerView(
    ...
    private val activeColor by lazy { ContextCompat.getColor(context, R.color.bg_green) }
    private val inactiveColor by lazy { ContextCompat.getColor(context, R.color.bg_grey) }
